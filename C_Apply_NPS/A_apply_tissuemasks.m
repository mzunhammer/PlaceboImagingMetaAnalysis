...
grey=apply_patternmask(fullfile(datadir,all_imgs),fullfile(maskdir,'grey.nii'));
white=apply_patternmask(fullfile(datadir,all_imgs),fullfile(maskdir,'white.nii'));
csf=apply_patternmask(fullfile(datadir,all_imgs),fullfile(maskdir,'csf.nii'));
brain=apply_patternmask(fullfile(datadir, all_imgs),fullfile(maskdir,'brainmask.nii'));
nobrain=apply_patternmask(fullfile(datadir, all_imgs),fullfile(maskdir,'inverted_brainmask.nii'));
...
grey_abs=apply_patternmask_abs(fullfile(datadir,all_imgs),fullfile(maskdir,'grey.nii'));
white_abs=apply_patternmask_abs(fullfile(datadir,all_imgs),fullfile(maskdir,'white.nii'));
csf_abs=apply_patternmask_abs(fullfile(datadir,all_imgs),fullfile(maskdir,'csf.nii'));
brain_abs=apply_patternmask_abs(fullfile(datadir, all_imgs),fullfile(maskdir,'brainmask.nii'));
nobrain_abs=apply_patternmask_abs(fullfile(datadir, all_imgs),fullfile(maskdir,'inverted_brainmask.nii'));
