...
control_R=df((strcmp(df.studyID,'bingel06')&~cellfun(@isempty,regexp(df.cond,'painNoPlacebo_R'))),{'subID','SIIPS','rating'});
placebo_R=df((strcmp(df.studyID,'bingel06')&~cellfun(@isempty,regexp(df.cond,'painPlacebo_R'))),{'subID','SIIPS','rating'});
control_L=df((strcmp(df.studyID,'bingel06')&~cellfun(@isempty,regexp(df.cond,'painNoPlacebo_L'))),{'subID','SIIPS','rating'});
placebo_L=df((strcmp(df.studyID,'bingel06')&~cellfun(@isempty,regexp(df.cond,'painPlacebo_L'))),{'subID','SIIPS','rating'});
