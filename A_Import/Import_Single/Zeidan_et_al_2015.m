...
zeidan.tr           =ones(size(zeidan.img)).*4000;
...
zeidan.imgsPerBlock =NaN(size(zeidan.cond)); %FSL analysis not comparable with fMRI studies
zeidan.nBlocks      =NaN(size(zeidan.cond)); %FSL analysis not comparable with fMRI studies
