...
conditioning=~cellfun(@isempty,regexp(stats.condi,'Conditioning','match'));

%% Analysis for ratings
summary_rating_cond=ForestPlotter(stats.rating(conditioning),...
...
summary_rating_sugg=ForestPlotter(stats.rating(~conditioning),...
              'studyIDtexts',studyIDtexts(~conditioning),...
              'outcomelabel','Pain ratings (Hedges''g)',...
              'type','random',...
              'summarystat','g',...
...
hgexport(gcf, '../../Protocol_and_Manuscript/NPS_placebo/NEJM/Figures/Placebo_Effect_Ratings_NoConditioning', hgexport('factorystyle'), 'Format', 'svg');
hgexport(gcf, '../../Protocol_and_Manuscript/NPS_placebo/NEJM/Figures/Placebo_Effect_Ratings_NoConditioning', hgexport('factorystyle'), 'Format', 'png');
crop('../../Protocol_and_Manuscript/NPS_placebo/NEJM/Figures/Placebo_Effect_Ratings_NoConditioning.png');

summary_ratings_cond_vs_sugg=compareGIVsummary(summary_rating_cond,summary_rating_sugg);
fprintf('Sub-group difference of Ratings for conditioning vs non-conditioning studies (based on random effects statistics) is %0.2f 95%%CI [%0.2f, %0.2f], z = %0.2f, p=%0.3f\n',...
     summary_ratings_cond_vs_sugg.g_diff.random.delta,...
     summary_ratings_cond_vs_sugg.g_diff.random.CI_lo,...
     summary_ratings_cond_vs_sugg.g_diff.random.CI_hi,...
     summary_ratings_cond_vs_sugg.g_diff.random.z,...
     summary_ratings_cond_vs_sugg.g_diff.random.p);
