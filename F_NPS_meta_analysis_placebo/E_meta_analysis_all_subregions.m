function E_meta_analysis_all_subregions(datapath,pubpath)
%% Meta-Analysis & Plots For NPS Subregions (Full Sample)

% Add folder with Generic Inverse Variance Methods Functions first
df_name='data_frame.mat';
load(fullfile(datapath,df_name),'df');
load(fullfile(datapath,'NPS_Subregion_labels.mat'));
