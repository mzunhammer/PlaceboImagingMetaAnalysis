...
%'Schenk'
baseline=mean(...
        [df{(strcmp(df.studyID,'schenk')&strcmp(df.cond,'pain_nolidocain_control')),'rating'},...
         df{(strcmp(df.studyID,'schenk')&strcmp(df.cond,'pain_nolidocain_placebo')),'rating'}],...
        2);
lidocain=mean(...
        [df{(strcmp(df.studyID,'schenk')&strcmp(df.cond,'pain_lidocain_control')),'rating'},...
         df{(strcmp(df.studyID,'schenk')&strcmp(df.cond,'pain_lidocain_placebo')),'rating'}],...
        2);
...
hgexport(gcf, 'Rating_Meta_Drugs.eps', hgexport('factorystyle'), 'Format', 'eps'); 
