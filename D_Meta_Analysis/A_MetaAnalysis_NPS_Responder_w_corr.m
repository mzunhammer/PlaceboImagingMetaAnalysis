...
studyIDtexts={
            'Atlas et al. 2012: Open vs hidden remifentanil drip infusion (expectation period)|heat';...
            ...
            'Ruetgen et al. 2015: Between-subject design >> NO RESPONDERS'
...
corr_rating_vs_NPS_pla(i)=corr(rating_diff,control-placebo);
...
corr_rating_vs_NPS_pla(i)=corr(rating_diff,con_NPS-pla_NPS);
...
% Get stats for between-subject design
stats(i)=betweenMetastats(placebo,control);
...
corr_rating_vs_NPS_pla(i)=corr(rating_diff,pla_effect);
