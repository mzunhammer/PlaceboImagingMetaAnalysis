...
stats(i)=withinMetastats(-rating_diff{:,:},0.6654);%NO RAW RATINGS AVAILABLE, ONLY RATING CONTRAST CONTROL-PLACEBO
...
hgexport(gcf, 'Ratings_Meta_Inclusive.eps', hgexport('factorystyle'), 'Format', 'eps'); 
