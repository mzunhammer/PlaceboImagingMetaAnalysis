...
outcome='NPScorrected';
comparison='comp_pla_vs_con_incl';
comparison='comp_pla_vs_con_basic';
comparison='comp_pla_vs_con_resp';

% comparison='comp_pain_vs_bl_incl';
% comparison='comp_pain_vs_bl_basic';
% comparison='comp_pain_vs_bl_resp';
% 
% comparison='comp_med_vs_con_incl';
% comparison='comp_med_vs_con_basic';
% comparison='comp_med_vs_con_resp';
% 
% comparison='comp_hipain_vs_lopain_incl';
% comparison='comp_hipain_vs_lopain_basic';
% comparison='comp_hipain_vs_lopain_resp';
...
istudy=strcmp(df.studyID,currstudy);
iistudy=find(istudy);
studyType=df.studyType(iistudy(1));

condition1=df(istudy&,outcome)
condition2=
