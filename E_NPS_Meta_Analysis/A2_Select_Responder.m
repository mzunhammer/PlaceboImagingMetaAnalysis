...
control_R=df((strcmp(df.studyID,'bingel')&~cellfun(@isempty,regexp(df.cond,'con_painNoPlacebo_R'))&~df.ex_all),['subID',varselect]);
placebo_R=df((strcmp(df.studyID,'bingel')&~cellfun(@isempty,regexp(df.cond,'con_painPlacebo_R'))&~df.ex_all),['subID',varselect]);
control_L=df((strcmp(df.studyID,'bingel')&~cellfun(@isempty,regexp(df.cond,'con_painNoPlacebo_L'))&~df.ex_all),['subID',varselect]);
placebo_L=df((strcmp(df.studyID,'bingel')&~cellfun(@isempty,regexp(df.cond,'con_painPlacebo_L'))&~df.ex_all),['subID',varselect]);
...
df_resp.condata{i}=df{(strcmp(df.studyID,'elsenbruch')&~cellfun(@isempty,regexp(df.cond,'pain_placebo_0%_analgesia'))&~df.ex_all),varselect};
df_resp.pladata{i}=df{(strcmp(df.studyID,'elsenbruch')&~cellfun(@isempty,regexp(df.cond,'pain_control_100%_analgesia'))&~df.ex_all),varselect};
%'freeman'
...
df_resp.condata{i}=df{(strcmp(df.studyID,'huber')&strcmp(df.cond,'conPainControl')&~df.ex_all),varselect};
df_resp.pladata{i}=df{(strcmp(df.studyID,'huber')&strcmp(df.cond,'conPainPlacebo')&~df.ex_all),varselect};
%'kessner'
