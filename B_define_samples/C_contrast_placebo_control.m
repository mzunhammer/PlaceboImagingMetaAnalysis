...
df.full(i).pla_minus_con.imgs_per_stimulus_block=[df.full(i).pla_minus_con.imgs_per_stimulus_block,...
                                                  NaN(size(df.full(i).pla_minus_con.imgs_per_stimulus_block))];
