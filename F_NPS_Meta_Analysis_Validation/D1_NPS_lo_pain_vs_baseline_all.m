...
hgexport(gcf, 'D1_NPS_lo_pain_vs_baseline_all.svg', hgexport('factorystyle'), 'Format', 'svg'); 
hgexport(gcf, '../../Protocol_and_Manuscript/NPS_validation/Figures/Figure5', hgexport('factorystyle'), 'Format', 'svg');
